...
function linkAction() {
  var navMenu = document.getElementById('nav-menu'); //When we click on each nav__link, we remote the show-menu class
...
function scrollTop() {
  var scrollTop = document.getElementById('scroll-top'); //when the scroll is higher than 200 vh, add the show-scroll class to the a tag with the scroll-top
